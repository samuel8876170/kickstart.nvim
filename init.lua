...
vim.api.nvim_create_autocmd('FileType', {
  ...
  callback = function(args)
    vim.diagnostic.enable(false, { buffer = args.buf })
  end,
})

vim.api.nvim_create_autocmd('FileType', {
  pattern = { 'k', 'q', 's', 'cpp', 'h', 'md' },
  callback = function()
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    dependencies = {
      ...
      { 'nvim-tree/nvim-web-devicons', enabled = vim.g.have_nerd_font, opt = ture },
    },
    config = function()
  ...
  -- require 'custom.plugins.cppdebug',
...
-- qls q/kdb+ lsp
local qls_bin = vim.fn.stdpath 'config' .. '/node_modules/.bin/qls'
vim.lsp.config('qls', {
  cmd = { qls_bin, '--stdio' },
  filetypes = { 'q', 'k' },
  root_markers = { '.git' },
